...
async function checkExistingEmail(account_email) {
  try {
    ...
    return email.rowCount > 0; // Return true if the email exists
  } catch (error) {
    console.error(error); // Log the error for debugging
    return false; // Return false on error to avoid blocking the registration
  }
}
...
async function getAccountList() {
  ...
  module.exports = { registerAccount, checkExistingEmail , loginAccount, getAccountByEmail,  getAccountById, updateAccount,  updatePassword, getAccountList };
